...
var modello = STRUCT([T([0,1])([-70,-15])(pista),R([0,1])(PI),T([2])([2.4]),tuttiTiranti,mappaParabrezza,fusolieraS,elicheMozzo,marmitte,ruote,COLOR([1,1,1,1]),ali,T([0,2])([11.9,2.0725]),mappaVerticalS,OrizontalStabilizers]);
DRAW(modello);